...
omap_path = r'enrichment_final/ENC_Py3_mra-main/mmr_landuse_1996_final.tif'
# Specify the actual map (data at time slice 2).
amap_path = r'enrichment_final/ENC_Py3_mra-main/mmr_landuse_2016_final.tif'
...
enriched_factors.to_csv('enrichment_MMR_6.csv')
