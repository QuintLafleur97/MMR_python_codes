...
base_path = base_path = "C:\\Users\\Quint\\Documents\\EPA\\Thesis\\ENC_Py3_mra-main\\enrichment_final\\ENC_Py3_mra-main_2\\ENC_Py3_mra-main\\"
# Set the case study
case_study = "mmr_2"
...
for c in range(0, max_distance):
    N.append(N_all[c])
points_path=output_path+"Rules\\"+"points_2.txt"
tails_path=output_path+"Rules\\"+"tails_2.txt"
...
print("log_data_ef")
print(log_data_ef)
#data_ef_file = output_path + "Rules\\ef.txt"
#log_data_ef_file = output_path + "Rules\\log_ef.txt"
#np.savetxt(data_ef_file, data_ef, fmt="%d")
#np.savetxt(log_data_ef_file, log_data_ef, fmt="%d")
# Categorisation --------------------------------------------------------------
        ...
        if points[j, i] == 1:
            ...
            if i + pas == j:
                ...
                if cont_table[i + pas, luc] > cont_table[luc, i + pas]:
                    print(cont_table[i + pas, luc])
                    print(cont_table[luc, i + pas])
                    point_levels[j, i] = 1
