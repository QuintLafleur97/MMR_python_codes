...
for x in range(0, len(testing_range)):
    ...
    print("test"+str(d2_low_ct_value))
    ...
    while run_count < max_runs:
        ...
        #ax = sns.heatmap(smap, cmap="YlGnBu")
        #ax.set_axis_off()
        # Calculate metrics included for analysis.
        # Calculate Kappa.
        
        it_metrics["fk"][run_count] = kappa(amap, smap,mask)
        # Calculate  Kappa Simulation.
        it_metrics["fks"][run_count] = ksim(omap, amap,
                                           smap,
                                           mask)
        # Calculate AAWCE.
